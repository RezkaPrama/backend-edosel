                    ...
                    <div class="position-relative">
                        <div class="modal-button mt-2">
                            <div class="row align-items-start">
                                <div class="col-sm">
                                    <a href="{{ route('admin.dokumen.create') }}" type="button" class="btn btn-success mb-4" ><i class="mdi mdi-plus me-1"></i> Tambah Dokumen</a>
                                </div>
                            </div>
                            <!-- end row -->
                        </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="badge bg-success font-size-12"><i class="mdi mdi-star me-1"></i>{{ $row->jabatan }}</span></td>
                                                <td class="text-center">{{ $row->jenis_karyawan }}</td>
                                                <td class="text-center">{{ $row->Shelf->no_rak }} - {{ $row->Shelf->nama_rak }}</td>
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a class="dropdown-item" href="{{ route('admin.dokumen.edit', $row->id) }}">Edit User</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
