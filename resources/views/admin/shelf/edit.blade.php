...
@section('title') Edit Rak @endsection
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Edit Rak</h5>
                    ...
                    <div class="p-4 border-top">
                        <form action="{{ route('admin.shelf.update', $shelf->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nama_rak" name="nama_rak" placeholder="Masukan Nama Rak" type="text" value="{{ old('shelf', $shelf->nama_rak) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="no_rak" name="no_rak" placeholder="Masukan no_rak" type="number" value="{{ old('shelf', $shelf->no_rak) }}"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="jumlah_ambalan" name="jumlah_ambalan" value="{{ old('shelf', $shelf->jumlah_ambalan) }}"
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('ket') is-invalid @enderror" name="ket" id="ket"
                                    placeholder="Enter Keterangan" rows="4">{{ old('shelf', $shelf->keterangan) }}</textarea>
